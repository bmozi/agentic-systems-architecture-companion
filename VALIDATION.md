...
pilot-packet SHA-256 values. It also validates the version 1.2.3 canonical
...
content/authority guards, and the six-row results inventory.
The mutation suite refreshes ordinary packet checksums and confirms that a
positive control passes while 22 structural and semantic regressions are
rejected. A
