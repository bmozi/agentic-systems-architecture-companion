...
- How much consequence may accumulate across workers and time?
- What happens after an unknown outcome, stale memory, or exhausted budget?
- Who holds technical containment, provider, per-order, finance, event
  correction, receiving/inventory, manual-continuity, and closure authority?
- Can the four possible orders be reconstructed through cancellation, residue,
