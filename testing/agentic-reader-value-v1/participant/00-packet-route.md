...
5. Open only these assets, in order:
   ...
   [Agent Authority Map](../../../agent-authority-map.md),
   [Governed Tool Contract](../../../governed-tool-contract.md), and
...
7. Freeze the initial workbook and detailed artifacts. Record artifact IDs,
...
8. Receive the facilitator's live update. Record it exactly; revise only after
   the initial freeze. Complete the four-order/correction register.
...
10. Complete the blank [One-Screen Decision Handoff](05-one-screen-handoff.md),
    ...
    owner, authority, date, number, budget, or evidence source: use
