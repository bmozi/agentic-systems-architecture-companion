...
| Handoff scanability | Stage B can locate value, decision, allowed/withheld scope, ownership/authority gaps, evidence, unknowns, recommended containment, actual containment status, next action, and reconsideration on one screen | | |
